...
namespace gameonfinal
{
    public static class SetupSecurity
    {
        public static void SeedUsers(UserManager<IdentityUser> userManager)
        {
            ...
            IdentityUser admin = userManager.FindByEmailAsync("admin@gameon.com").Result;

            if (admin == null)
            {
                IdentityUser sysadmin = new IdentityUser();
                sysadmin.Email = "admin@gameon.com";
                sysadmin.UserName = "admin@gameon.com";
